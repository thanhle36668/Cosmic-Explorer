...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2025 at 04:28 PM
...
CREATE TABLE `about_services` (
  ...
  `name_2` varchar(250) NOT NULL,
  `name_3` varchar(250) NOT NULL,
...
INSERT INTO `about_services` (`id`, `name`, `name_2`, `name_3`, `description`, `description_2`, `description_3`, `photo`, `photo_2`, `photo_3`) VALUES
(1, 'Inspire Curiosity', 'Share Timely Discoveries', 'Make Space Accessible', 'We believe the sky is not a limit, but a doorway to endless exploration and learning. Our mission is to awaken curiosity and inspire a genuine passion for the cosmos — whether you\\\'re a stargazer, a student, or simply intrigued by the universe.', 'Astronomy is evolving rapidly — from new planetary findings to gravitational waves and space missions. We’re dedicated to providing accurate, up-to-date, and easy-to-understand news and discoveries from the ever-changing world of space science.', 'Our goal is to make complex space knowledge more relatable and engaging. Through clear explanations and creative storytelling, we bring astronomy closer to the public — so anyone, regardless of background, can enjoy and explore the universe.', 'images/about/1753794126_CaTkFMUkuS.jpg', 'images/about/1753794126_fJHFvUEppS.jpg', 'images/about/1753794126_bvVPx7QUrS.jpg');
...
(17, 'hrllo', 1, NULL, 'Thành', 'thanhle36668@gmail.com', 14, '2025-07-29 19:47:31', '2025-07-29 19:48:05');
...
CREATE TABLE `introduction` (
  ...
  `short_introduction_2` varchar(255) DEFAULT NULL,
...
INSERT INTO `introduction` (`id`, `website_name`, `short_introduction`, `short_introduction_2`, `company_description`, `photo`, `photo_2`, `photo_3`, `photo_4`, `photo_5`, `photo_6`, `photo_7`, `photo_8`) VALUES
(1, 'COSMIC EXPLORER', 'Astronomical information', 'about the universe', 'We are a group of amateur astronomers working together to improve astronomical knowledge and observational skills. We make ourselves and our instruments available to promote public interest in astronomy. Cosmos members are a varied group of colleagues who share a curiosity about the sky. Some members are scientists or engineers, while others are artists or craftspeople, building contractors or college students. Ability levels span the range from novice to expert.', 'images/introduction/1753795746_OFakhtUORp.jpg', 'images/introduction/1753626494_qDA2RVk56E.png', 'images/introduction/1753626494_7UXlLZcDXI.png', 'images/introduction/1753626494_B9s8rOHKFw.png', 'images/introduction/1753626494_HEcxivIPgW.png', 'images/introduction/1753802158_EY7z90pdLm.png', 'images/introduction/1753626494_okmZTu8J7Z.png', 'images/introduction/1753626494_k4az3qwKnc.png');
...
CREATE TABLE `messages` (
  ...
  `time_received_message` timestamp NOT NULL DEFAULT current_timestamp(),
  `time_reply_message` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  `status` tinyint(1) NOT NULL,
...
INSERT INTO `messages` (`id`, `sender_name`, `sender_email`, `slug`, `message`, `time_received_message`, `time_reply_message`, `status`, `reply_message`, `replied_by`) VALUES
(91, 'thànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthành', 'thanhle36668@gmail.com', 'thanhle36668@gmail.com', 'thànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthànhthành', '2025-07-31 06:24:07', NULL, 0, NULL, NULL);
...
(12, '2025_07_17_200330_add_slug_to_example_table', 4);
...
INSERT INTO `observatories` (`id`, `name`, `slug`, `status`, `location`, `photo`, `photo_2`, `photo_3`, `photo_4`, `altitude_meters`, `established_year`, `managing_organization`, `main_instruments`, `primary_research_areas`, `public_access_info`, `created_at`, `updated_at`) VALUES
(1, 'Mauna Kea Observatories', 'Mauna-Kea-Observatories-(MKO)', 1, 'Mauna Kea summit, Hawaii, USA', 'images/observatories/1753683058_tBBVbeJQRm.jpg', 'images/observatories/1753683058_Oshd6oJLT8.jpg', 'images/observatories/1753683058_6SGsa8Y0sv.jpg', 'images/observatories/1753683058_ohvGvB7xtg.jpg', '4,205 meters. Extremely high, offers excellent infrared observation and very sharp images due to stable atmosphere', 'First telescope began operating in 1970', 'A collection of ~13 observatories from various nations/organizations', 'Collection of giant telescopes (optical, infrared)', 'Broad, from exoplanets to cosmology. Discoveries here help us understand the universe\'s origin, how galaxies develop, and the search for life beyond Earth', 'Has a Visitor Information Station (VIS) at a lower elevation', '2025-07-28 03:43:57', '2025-07-28 06:10:58'),
(2, 'Parana Observatory', 'Paranal', 1, 'Atacama Desert, Chile', 'images/observatories/1753683033_u22ZmNACbJ.jpg', 'images/observatories/1753683033_mKWr0OX1yj.jpg', 'images/observatories/1753683033_b0xMLtxX1S.jpg', 'images/observatories/1753683033_oOuojbyMxF.jpg', '2,635 meters. Good height combined with extremely dry climate, ideal for both optical and infrared with nearly cloudless skies', 'Began operations in 1999', 'Run by ESO', 'Very Large Telescope (VLT), 4x 8.2-meter telescopes (can be combined)', 'Exoplanets, black holes, galaxies, cosmology. It\'s especially successful in directly imaging distant planets and tracking stars moving around the supermassive black hole at our galaxy\'s center', 'Offers free guided tours on Saturdays (registration required)', '2025-07-28 03:43:57', '2025-07-28 06:10:33'),
(3, 'Las Campanas Observatory', 'Las-Campanas-(LCO)', 1, 'Atacama Desert, Chile', 'images/observatories/1753682996_ySZl16LoiP.webp', 'images/observatories/1753682996_AIfFSzI5f0.jpg', 'images/observatories/1753682996_4SZZUNT0PH.jpg', 'images/observatories/1753682996_fQT8USSz7k.jpg', '2,400 meters. High desert location provides very dark skies and stable image quality', 'Began operating in 1969', 'Belongs to the Carnegie Institution for Science', 'Twin 6.5-meter Magellan Telescopes. Future home of Giant Magellan Telescope (GMT)', 'Galaxy formation, stellar variability, supernovae. They study how galaxies are formed, changes in stars, and powerful star explosions to understand the universe', 'Guided tours available on Saturdays (reservation required)', '2025-07-28 03:43:57', '2025-07-28 06:09:56'),
(5, 'Kitt Peak National Observatory', 'Kitt-Peak-National-(KPNO)', 1, 'Arizona, USA', 'images/observatories/1753682944_FkMSbwhKa7.webp', 'images/observatories/1753682944_ztd2yMNMUH.jpg', 'images/observatories/1753682944_EQmQZdJWfZ.jpg', 'images/observatories/1753682944_YkjRu2rk1F.jpg', '2,096 meters. Reasonable height with many clear nights and clean air, versatile for various observations', 'Founded in 1958', 'First U.S. national optical observatory, now part of NOIRLab', 'Over two dozen telescopes (Mayall 4m, WIYN 3.5m)', 'Near-Earth asteroids, dark matter, distant galaxies. KPNO helps find potentially hazardous objects near Earth and maps large structures in the universe to better understand dark matter distribution', 'Visitor Center open daily, with daytime tours and evening stargazing programs', '2025-07-28 03:43:57', '2025-07-28 06:09:04'),
(6, 'Palomar Observatory', 'Palomar', 1, 'California, USA', 'images/observatories/1753682900_dpSI3BWgef.jpg', 'images/observatories/1753682900_4wKLK6RSIO.jpg', 'images/observatories/1753682900_DRaGWWR5Sk.jpg', 'images/observatories/1753682900_BsTZDMKKCD.jpg', '1,712 meters. Reduces atmospheric blur and was known for good image quality when built', 'Operational since 1949', 'Owned by Caltech', 'Iconic 5.1-meter (200-inch) Hale Telescope', 'Asteroids, outer Solar System objects, supernovae, exoplanets. Palomar continues to explore planets and unusual objects within and beyond our solar system, as well as study bright star explosions', 'Self-guided tours of the 200-inch telescope area, on-site museum', '2025-07-28 03:43:57', '2025-07-28 06:08:20'),
(7, 'Cerro Tololo Inter-American Observatory', 'Cerro-Tololo-Inter-American-(CTIO)', 1, 'Cerro Tololo summit, Northern Chile', 'images/observatories/1753682830_Xo6Nmz9GE4.jpg', 'images/observatories/1753682830_AaUXjhLrn7.jpg', 'images/observatories/1753682830_YJZhfpIHpX.jpg', 'images/observatories/1753682830_3ZB5UrGq5g.jpg', '2,200 meters. Height combined with Chile\'s dry climate provides clear, stable skies, ideal for large surveys', 'Began operations in 1963', 'Part of NOIRLab, managed by the U.S. National Science Foundation (NSF)', '4-meter Victor M. Blanco Telescope, with DECam survey camera', 'Cosmology, dark energy, large-scale galaxy surveys. CTIO is especially crucial for studying \"dark energy\" and mapping galaxies across vast areas to understand the universe\'s expansion', 'Offers guided tours on specific Saturdays (reservations required)', '2025-07-28 03:43:57', '2025-07-29 03:59:40');
...
CREATE TABLE `planets` (
  ...
  `photo_3` varchar(250) DEFAULT NULL,
  `photo_4` varchar(250) DEFAULT NULL,
  `photo_5` varchar(250) DEFAULT NULL,
...
INSERT INTO `videos` (`id`, `name_video`, `status`, `genre`, `source_video`, `description_short`, `channel`, `created_at`, `updated_at`) VALUES
(1, 'Black Holes: Crash Course Astronomy #33', 1, 'Popular Science, Education, Astronomy', 'https://www.youtube.com/embed/qZWPBKULkdQ?si=3xNauGOySAxxvOQw', 'Time and Light Eaters! Are you ready to discover how they\'re born from the death of colossal stars and what makes them so hauntingly bizarre?', 'CrashCourse', '2025-07-29 04:56:58', '2025-07-29 05:00:39'),
(2, 'Origins of the Universe 101 | National Geographic', 1, 'Popular Science, Documentary, Cosmology', 'https://www.youtube.com/embed/HdPzOWlLrbE?si=GjSi8Fk2scgwB0s-', 'How Did the Universe Begin? Join National Geographic to unveil the mysteries of the very first moments of everything, exploring the incredible journey our cosmos has taken!', 'National Geographic', '2025-07-29 04:56:58', '2025-07-29 05:00:41'),
(3, 'Black Holes Explained – From Birth to Death', 1, 'Popular Science, Education, Astrophysics', 'https://www.youtube.com/embed/e-P5IFTqB98?si=zXS5HWg_ix1o13A1', 'Black Holes Decoded: From Mysterious Origins to Unbelievable Endings! This video will take you deep inside these cosmic voids, revealing how they work and even how they might \"disappear\" from the universe!', 'Kurzgesagt – In a Nutshell', '2025-07-29 04:56:58', '2025-07-29 05:00:42'),
(4, 'The Beginning of Everything -- The Big Bang', 1, 'Popular Science, Education, Cosmology', 'https://www.youtube.com/embed/wNDGgL73ihY?si=Qm5KTxnIRZ4kIcvj', 'The Big Bang: What Happened in the Universe\'s First Second? Don\'t miss this journey back in time to the very origin of everything, where space, time, and matter began our grand story!', 'Kurzgesagt – In a Nutshell', '2025-07-29 04:56:58', '2025-07-29 06:37:20');
...
ALTER TABLE `videos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name_video` (`name_video`);
