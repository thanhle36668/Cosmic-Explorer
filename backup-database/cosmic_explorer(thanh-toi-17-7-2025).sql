...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2025 at 06:53 PM
...
(4, 'Mars', 'The \"Red Planet\" is famous for its distinct reddish hue, caused by iron oxide on its surface. Mars has two small moons and evidence suggesting liquid water existed in the past, making it a prime candidate in the search for extraterrestrial life', 'mars-planet.png', 'mars-planet-2.png', 'mars-planet-3.png', 'mars-planet-4.png', 'mars-planet-extra.jpg', 'Known since ancient times', '6,779 km', 'Approximately 78.3 million km', 'Approximately 227.9 million km', 'Commonly known as the \"Red Planet\" due to the distinctive rust-red hue of its iron oxide-rich soil, Mars has captivated humanity for centuries. It features polar ice caps, volcanoes, canyons, and evidence of ancient riverbeds, suggesting that liquid water once flowed freely on its surface. Mars has two small, irregularly shaped moons, Phobos and Deimos. Extensive missions have been sent to Mars, making it a primary focus for the search for past or present extraterrestrial life. Its very thin atmosphere is mostly Carbon dioxide, and internally, it has an iron, nickel, and sulfur core, along with a silicate mantle and crust. Water ice and dioxide ​ice are also found at its poles and beneath the surface'),
