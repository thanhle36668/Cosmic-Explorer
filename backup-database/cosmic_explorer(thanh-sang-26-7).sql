...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 25, 2025 at 08:38 PM
...
(1, 'Inspire Curiosity', 'We believe the sky is not a limit, but a doorway to endless exploration and learning. Our mission is to awaken curiosity and inspire a genuine passion for the cosmos — whether you\\\'re a stargazer, a student, or simply intrigued by the universe.', 'about_services_1.jpg'),
(2, 'Share Timely Discoveries', 'Astronomy is evolving rapidly — from new planetary findings to gravitational waves and space missions. We’re dedicated to providing accurate, up-to-date, and easy-to-understand news and discoveries from the ever-changing world of space science.', 'about_services_2.jpg'),
(3, 'Make Space Accessible', 'Our goal is to make complex space knowledge more relatable and engaging. Through clear explanations and creative storytelling, we bring astronomy closer to the public — so anyone, regardless of background, can enjoy and explore the universe.', 'about_services_3.jpg');
...
CREATE TABLE `discovery` (
  ...
  `name_photo_2` varchar(255) NOT NULL,
...
CREATE TABLE `messages` (
  ...
  `time_reply_message` datetime DEFAULT NULL,
  `status` tinyint(1) NOT NULL,
