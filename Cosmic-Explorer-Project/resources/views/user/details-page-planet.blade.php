            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="header-text">
                        ...
                        <ul class="info-list">
                            <li><strong class="d-inline">Discovery Date:</strong> {{ $planet_details->discovery_date }}
                            </li>
                            <li><strong class="d-inline">Size (Diameter):</strong> {{ $planet_details->diameter_km }}</li>
                            <li><strong class="d-inline">Average Distance to Earth:</strong>
                                {{ $planet_details->avg_distance_to_earth_km }}
                            </li>
                            <li><strong class="d-inline">Average Distance to the Sun:</strong>
                                {{ $planet_details->avg_distance_to_sun_km }}
                            </li>
                        </ul>
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="owl-banner owl-carousel ">
                        <div class="item">
                            <img class="rounded-circle" src="{{ asset('storage/images') }}/planets/{{ $planet_details->photo }}"
                                alt="" height="480px" width="480px">
                        </div>
                        <div class="item">
                            <img class="rounded-circle" src="{{ asset('storage/images') }}/planets/{{ $planet_details->photo_2 }}"
                                alt="" height="480px" width="480px">
                        </div>
                        <div class="item">
                            <img class="rounded-circle" src="{{ asset('storage/images') }}/planets/{{ $planet_details->photo_3 }}"
                                alt="" height="480px" width="480px">
                        </div>
                        <div class="item">
                            <img class="rounded-circle" src="{{ asset('storage/images') }}/planets/{{ $planet_details->photo_4 }}"
                                alt="" height="480px" width="480px">
                        </div>
                    </div>
                </div>
