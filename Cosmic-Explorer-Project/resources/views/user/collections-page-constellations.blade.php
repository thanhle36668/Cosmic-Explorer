...
@section('title')
    <title>Collection of Constellations</title>
@endsection
...
@section('section-change')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h1 style="text-transform: uppercase">Collection of Constellations</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- ***** Collection of Constellations End ***** -->
