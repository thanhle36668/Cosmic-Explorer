...
@section('title')
    <title>Collection of Observatories</title>
@endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-content">
                        <h1 style="text-transform: uppercase">Collection of Observatories</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                @foreach ($observatories as $observatory)
                    <div id="{{ $observatory->name }}"
                        ...
                        <div
                            ...
                            <img src="{{ asset($observatory->photo) }}" alt="{{ basename($observatory->photo) }}"
