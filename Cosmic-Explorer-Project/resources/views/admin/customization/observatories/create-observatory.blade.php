                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input id="name" name="name" class="form-control" value="{{ old('name') }}"
                            placeholder="e.g., Mauna Kea Observatories, Palomar Observatory" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="location" name="location" class="form-control" value="{{ old('location') }}"
                            placeholder="e.g., gMauna Kea summit, Hawaii, USA" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input id="altitude_meters" name="altitude_meters" class="form-control"
                            ...
                            placeholder="e.g., 4,205 meters. Extremely high, offers excellent infrared observation and very sharp images due to stable atmosphere"
                            required>
                    </div>
                    <div class="form-group">
                        ...
                        <input id="established_year" name="established_year" class="form-control"
                            ...
                            placeholder="e.g., First telescope began operating in 1970" required>
                    </div>
                    <div class="form-group">
                        ...
                        <input id="managing_organization" name="managing_organization" class="form-control"
                            ...
                            placeholder="e.g., Run by ESO, Belongs to the Carnegie Institution for Science" required>
                    </div>
                    <div class="form-group">
