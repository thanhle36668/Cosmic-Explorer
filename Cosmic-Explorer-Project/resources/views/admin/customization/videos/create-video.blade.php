                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="genre" name="genre" class="form-control" rows="5" cols="5"
                            placeholder="e.g., Popular Science, Education, Astronomy" required>{{ old('genre') }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description_short" name="description_short" class="form-control" rows="10" cols="10"
                            placeholder="e.g., Time and Light Eaters! Are you ready to discover how they're born from the death of colossal stars and what makes them so hauntingly bizarre?"
