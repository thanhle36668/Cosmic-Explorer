...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <h3 class="card-title col-8 d-flex align-items-center">All Video</h3>
                <div class="card-tools col-4 d-flex justify-content-end align-items-center">
                    <a href="{{ route('collections-videos') }}" class="btn btn-info mr-2" style="padding: 3px 6px;">View</a>
        ...
        <div class="card-body p-0">
            @if (session('success-create-video'))
                <div id="successAlert" class="alert alert-success alert-dismissible fade show mt-2 bg-success"
                    role="alert">
                    {{ session('success-create-video') }}
                </div>
            @endif
            @if (session('success-delete-video'))
                <div id="successAlert" class="alert alert-success alert-dismissible fade show mt-2 bg-success"
                    role="alert">
                    {{ session('success-delete-video') }}
                </div>
            @endif
