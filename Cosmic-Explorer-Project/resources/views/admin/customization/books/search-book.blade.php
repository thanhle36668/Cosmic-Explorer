...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <h3 class="card-title col-8 d-flex align-items-center">Search Book</h3>
                    ...
                    @if ($search_book->isNotEmpty())
                        @foreach ($search_book as $book)
                            <tr class="text-center bg-secondary-subtle">
                                ...
                                @if ($book->status)
                                    <td>
                                        <a href="{{ route('details-book', $book->slug) }}" class="btn btn-info"
                                            target="blank">
        ...
        <div class="card-footer">
            <div class="row d-flex flex-row-reverse">
                <a href="{{ route('admin.customization-books') }}" class="btn btn-info col-2">Back</a>
            </div>
        </div>
    </div>
@endsection
