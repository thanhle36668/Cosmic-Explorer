                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="link_amazon" name="link_amazon" class="form-control" rows="10" cols="10"
                            placeholder="e.g., https://a.co/d/e9vV6fk - Link Amazon">{{ old('link_amazon') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="description">Description</label>
                        <textarea id="description" name="description" class="form-control" rows="10" cols="10"
                            placeholder="e.g., Cosmosis a classic science book that takes readers on a journey through 15 billion years of cosmic evolution, from the origins of everything to humanity's place in the universe. Written in a captivating style, Sagan blends science with philosophy, fostering curiosity and wonder about the vast cosmos"
                            required>{{ old('description') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="main_title">Main Title</label>
                        <textarea id="main_title" name="main_title" class="form-control" rows="10" cols="10"
                            placeholder="e.g., The Cosmos: A Grand Symphony of Science and Wonder" required>{{ old('main_title') }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="main_content">Main Content</label>
                        <textarea id="main_content" name="main_content" class="form-control" rows="10" cols="10"
                            placeholder="e.g., This book explores the immense scale of space and time, from tiny subatomic particles to billions of galaxies, while delving into humanity's historical understanding of the cosmos, from ancient myths to groundbreaking scientific discoveries by great thinkers...."
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="main_content_2" name="main_content_2" class="form-control" rows="10" cols="10"
                            placeholder="e.g., Finally, Sagan discusses the Voyager missions and their golden records, carrying a message from humanity to potential alien civilizations, symbolizing our innate desire to explore, communicate, and connect with the universe beyond our own world"
