...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?php echo e(asset('user')); ?>/bootstrap/css/bootstrap.min.css" rel="stylesheet">


    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="<?php echo e(asset('user')); ?>/css/fontawesome.css">
    <link rel="stylesheet" href="<?php echo e(asset('user')); ?>/css/template-cosmic-explorer.css">
...
<body>
    ...
    <!-- ***** Change Section ***** -->
    <?php echo $__env->yieldContent('section-change'); ?>
    <!-- ***** Change Section End***** -->

    <!-- ***** Contact ***** -->
    <section class="contact" style="background-image: url('<?php echo e(asset('images')); ?>/background-dark.jpg')">
    ...
    <script src="<?php echo e(asset('user')); ?>/jquery/jquery.min.js"></script>
    <script src="<?php echo e(asset('user')); ?>/bootstrap/js/bootstrap.min.js"></script>

    <script src="<?php echo e(asset('user')); ?>/js/isotope.min.js"></script>
...
<?php /**PATH C:\Users\Admin\Desktop\Cosmic-Explorer\Cosmic-Explorer-Project\resources\views/layouts/user/cosmic-explorer.blade.php ENDPATH**/ ?>